...
export function ArteUnica() {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      saveDraft.mutate({
        type: 'static_post',
        title: hookSlide.headline,
        data: { slide: hookSlide, briefing, angle, objective, channel } as unknown as Record<string, unknown>,
      });
    } catch (err) {
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1.5">
                ...
                <button
                  ...
                  className="p-2 rounded-lg border border-border text-text-muted hover:text-brand hover:border-brand/50 transition-colors"
                ...
                {imageUrl && (
                  <button
                    ...
                    className="p-2 rounded-lg border border-border text-text-muted hover:text-red-400 hover:border-red-400/50 transition-colors"
                ...
                <button
                  ...
                  className="p-2 rounded-lg border border-border text-text-muted hover:text-text-primary hover:border-text-muted transition-colors disabled:opacity-50"
                >
