...
serve(async (req) => {
  ...
  try {
    ...
    const styledPrompt = `${finalPrompt}. Shot on iPhone 15 Pro aesthetic — candid, handheld, slightly casual but beautiful. Looks like an authentic photo a colleague took, NOT a corporate photoshoot or stock image. No studio lighting, no posed setup. Photojournalistic documentary style, intimate and real. The subject is a Brazilian independent professional — consultant, designer, lawyer, architect, therapist, accountant, coach, photographer, engineer, or similar — actively working. Setting: well-equipped home office with an organized desk in a bright apartment, informal coworking space, neighborhood café while working on a laptop, or a simple but professional studio or clinic — NOT a glass-walled corporate tower, NOT a studio backdrop, NOT a staged production setup. Casual professional or profession-appropriate attire. Natural window light or warm ambient light, photorealistic, high quality. No text, no logos, no watermarks. HARD EXCLUSIONS — must NOT contain: calloused hands, worn tables, modest homes, humble kitchens, simple tiles, cracked walls, plastic chairs, poverty aesthetics, favela elements, stained walls, shanty environments, or anything suggesting low-income settings. The scene must show professional work in progress — dignified, real, authentic Brazilian professional life.`;
