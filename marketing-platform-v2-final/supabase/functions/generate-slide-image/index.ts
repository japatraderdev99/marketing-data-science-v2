...
serve(async (req) => {
  ...
  try {
    ...
    const styledPrompt = `${finalPrompt}. Brazilian editorial photography — warm, authentic, real. Mandatory color grading: warm amber/golden tones, not cold or desaturated. Choose the most fitting style: (A) DOCUMENTARY — candid moment in a real Brazilian setting: apartment room with view of neighborhood buildings through the window, small neighborhood workshop or storefront (oficina, consultório simples de bairro), cobblestone street at golden hour, Brazilian residential interior with late-afternoon window light. Subject caught naturally mid-action. (B) EDITORIAL PORTRAIT — subject centered facing camera, holding a tool of their profession, against a warm neutral textured background (sandy taupe, aged plaster wall, or kraft paper texture), soft diffused warm light, subtle vintage worn-border framing like an old photograph. Both styles: authentic Brazilian person with diverse phenotype (mixed race, moreno, pardo, negro, or branco), casual clothing appropriate to their work (camiseta, jeans, or simple work clothes — NEVER a corporate suit or business attire), genuine warm expression, high quality photorealistic. STRICTLY AVOID: glass-walled modern office, co-working space with neon signs, Apple laptop on white minimalist desk, cold studio strobe lighting, corporate headshot aesthetic, generic American stock photo style. No text, no logos, no watermarks. The image feels warm, Brazilian, real, and dignified.`;
