...
serve(async (req) => {
  ...
  try {
    ...
    const styledPrompt = `${finalPrompt}. Photojournalistic documentary style, candid and authentic. The subject is a Brazilian independent professional — a consultant, designer, lawyer, architect, therapist, accountant, coach, photographer, engineer, or similar white-collar or creative profession — actively working in their proper professional environment: modern office, creative studio, clinic, university, or co-working space. Business casual or profession-appropriate attire. Natural or diffused window light, photorealistic, high quality. No text, no logos, no watermarks. HARD EXCLUSIONS — the final image must NOT contain: calloused hands, worn tables, modest homes, humble kitchens, simple tiles, cracked walls, plastic chairs, poverty aesthetics, favela elements, stained walls, shanty environments, or anything suggesting low-income settings. The scene must show professional work in progress — dignified, credible, aspirational but authentic.`;
